...
public class ManagerEarnMore {
    private final Employee employee;
    private final double averageOfSubordinates;
    private final double deviation;

    public ManagerEarnMore(Employee employee, double averageOfSubordinates, double deviation) {
    ...
    public boolean equals(Object o) {
        ...
        ManagerEarnMore that = (ManagerEarnMore) o;
